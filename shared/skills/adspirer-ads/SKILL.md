...
1. Extract value propositions from:
   ...
   - Brand docs ({{CONTEXT_FILE}} if it exists)
...
5. For fatigued ads:
   ...
   - Present new creative options (filtered through brand voice if {{CONTEXT_FILE}} exists)
...
- Read {{CONTEXT_FILE}} for known competitors (check Competitors section)
...
- Update {{CONTEXT_FILE}} Competitors section with findings
