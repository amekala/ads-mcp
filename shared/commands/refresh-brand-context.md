---
description: Re-scan brand docs and update {{CONTEXT_FILE}} with latest info
---
Re-scan all files in the project folder and pull fresh data from Adspirer MCP. Update {{CONTEXT_FILE}} with any changes.
...
5. Update {{CONTEXT_FILE}} with the refreshed data — merge new info, update performance numbers, note any changes
