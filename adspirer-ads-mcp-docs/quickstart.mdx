...
<Steps>
  <Step title="Choose Your AI Client">
    ...
    | Client | Best For |
    |--------|----------|
    | [Claude](/mcp/connect/claude) | Easiest setup — native MCP support |
    | [ChatGPT](/mcp/connect/chatgpt) | GPT-4 with ad management tools |
    | [Claude Code](/mcp/connect/claude-code) | Terminal-based, full plugin with agent + skills |
    | [Cursor](/mcp/connect/cursor) | Developer-first AI editor |
    | [Codex](/mcp/connect/codex) | OpenAI CLI agent |
    | [OpenClaw](/mcp/connect/openclaw) | Agentic platform with plugins |
    | [Windsurf](/mcp/connect/windsurf) | Codeium AI editor |
  </Step>
...
<CardGroup cols={2}>
  <Card title="Explore Tools by Platform" icon="wrench" href="/mcp/platforms/google-ads">
    See all 100+ tools organized by ad platform
  </Card>
  <Card title="Agent Skills" icon="wand-magic-sparkles" href="/mcp/skills/overview">
