...
<CardGroup cols={3}>
  <Card title="Claude" href="/mcp/connect/claude">
    Desktop, Web & iOS
  </Card>
  <Card title="ChatGPT" href="/mcp/connect/chatgpt">
    Desktop & Web
  </Card>
  <Card title="Claude Code" href="/mcp/connect/claude-code">
    Terminal IDE
  </Card>
  <Card title="Cursor" href="/mcp/connect/cursor">
    AI Code Editor
  </Card>
  <Card title="Codex" href="/mcp/connect/codex">
    OpenAI CLI
  </Card>
  <Card title="OpenClaw" href="/mcp/connect/openclaw">
    Agentic Platform
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="How MCP Works" icon="circle-nodes" href="/mcp/how-mcp-works">
