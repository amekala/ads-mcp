...
1. Extract value propositions from:
   ...
   - Brand docs (AGENTS.md if it exists)
...
5. For fatigued ads:
   ...
   - Present new creative options (filtered through brand voice if AGENTS.md exists)
...
- Read AGENTS.md for known competitors (check Competitors section)
...
- Update AGENTS.md Competitors section with findings
