...
---
Re-scan all files in the project folder and pull fresh data from Adspirer MCP. Update AGENTS.md with any changes.
...
5. Update AGENTS.md with the refreshed data — merge new info, update performance numbers, note any changes
